...
Result['A'] = {'X':'D', 'Y':'W', 'Z':'L'}
Result['B'] = {'X':'L', 'Y':'D', 'Z':'W'}
Result['C'] = {'X':'W', 'Y':'L', 'Z':'D'}
...
SymbolMap['Z'] = "Scissors"


def scorePlay(play: list[str]) -> int:
    oppo, me = play
    score = Points[Result[oppo][me]] + Points[me]
    print(f"opponent {oppo, SymbolMap[oppo]}, me {me, SymbolMap[me]}, score {score}")
    return score 
